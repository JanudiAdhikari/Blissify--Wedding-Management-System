...
const AuthenticationPage = ({ mode, role }) => {
    ...
    const bgpic = "https://images.pexels.com/photos/811572/pexels-photo-811572.jpeg"
    ...
    const handleSubmit = (event) => {
        ...
        if (mode === "Register") {
            ...
            if (role === "Vendor") {
                ...
                const vendorFields = { name, email, password, role, shopName }
                dispatch(authUser(vendorFields, role, mode))
            }
            else {
                const coupleFields = { name, email, password, role }

                dispatch(authUser(coupleFields, role, mode))
            }
        }
        else if (mode === "Login") {
                    ...
                    >
                        ...
                        {role === "Vendor" && mode === "Register" &&
                            <Typography variant="h7">
                                Create your own shop by registering as an Vendor.
                                <br />
                                You will be able to add services and negotiate them.
                            </Typography>
                        }

                        {role === "Couple" && mode === "Register" &&
                            <Typography variant="h7">
                                Register now to explore and Choose Vendors
                            </Typography>
                        }
