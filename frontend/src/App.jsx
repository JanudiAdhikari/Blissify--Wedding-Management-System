...
const App = () => {
  ...
  const { isLoggedIn, currentToken, currentRole, serviceData } = useSelector(state => state.user);
  ...
  return (
    <BrowserRouter>
      {(!isLoggedIn && currentRole === null) &&
        <>
          ...
          <Routes>
            ...
            <Route path="/ServiceSearch" element={<CoupleSearch mode="Desktop" />} />

            <Route path="/Coupleregister" element={<AuthenticationPage mode="Register" role="Couple" />} />
            <Route path="/Couplelogin" element={<AuthenticationPage mode="Login" role="Couple" />} />
            <Route path="/Vendorregister" element={<AuthenticationPage mode="Register" role="Vendor" />} />
            <Route path="/Vendorlogin" element={<AuthenticationPage mode="Login" role="Vendor" />} />
          </Routes>
        </>
      }
      ...
      {(isLoggedIn && (currentRole === "Vendor" || currentRole === "Shopinvoice")) && (
        <>
          <VendorDashboard />
        </>
      )}
