                                ...
                                <Stack spacing={3}>
                                    {
                                        ...
                                        <FormControl fullWidth>
                                            <InputLabel id="demo-simple-select-label">Meal Preferences</InputLabel>
                                            <Select
                                            ...
                                            >
                                                <MenuItem value="veg">Vegitarian</MenuItem>
                                                <MenuItem value="non">Non-Vegitarian</MenuItem>
                                                {notesList ?
                                    ...
                                    <FormControl fullWidth>
                                        ...
                                        <Select
                                            ...
                                            required
                                        >
                                            <MenuItem value="Present">Participating</MenuItem>
                                            <MenuItem value="Absent">Not Participating</MenuItem>
                                        </Select>
                                    </FormControl>
                                    <FormControl>
                                        <TextField
