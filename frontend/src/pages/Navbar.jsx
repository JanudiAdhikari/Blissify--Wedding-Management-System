...
const Navbar = () => {
    ...
    const totalQuantity = currentUser && currentUser.invoiceDetails && currentUser.invoiceDetails.reduce((total, item) => total + item.quantity, 0);
                            ...
                            <>
                                ...
                                >
                                    <MenuItem onClick={() => {
                                        ...
                                        <Typography textAlign="center">Sign in as Couple</Typography>
                                    </MenuItem>
                                    <MenuItem onClick={() => {
                    ...
                    {currentRole === "Couple" &&
                        <Box sx={{ flexGrow: 0, display: 'flex' }}>
                            <Tooltip title="Invoice">
                                <IconButton onClick={handleOpenInvoice} sx={{ width: "4rem", color: 'inherit', p: 0 }}>
