            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Box component="main" sx={styles.boxStyled}>
                    ...
                    <Routes>
                        ...
                        <Route path="/Vendor/services/service/:id" element={<ViewServiceVendor />} />

                        {
                            currentRole === "Shopinvoice" &&
                            <>
                                <Route path="/Vendor/shopinvoice" element={<ShopinvoiceSpecial />} />
                                <Route path="/Vendor/uploadservices" element={<Services serviceData={serviceDataList} />} />
                            </>
                        }

                        <Route path="/Vendor/bookings" element={<ShowBookings />} />
                        <Route path="/Vendor/bookings/couples/:id" element={<ShowCouples />} />
                        <Route path="/Vendor/bookings/service/:id" element={<ViewServiceVendor />} />
